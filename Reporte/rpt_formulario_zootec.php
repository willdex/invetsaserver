...
<html lang="es">
  <head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>  <title>INFORME DE MANTENIMIENTO (ZOOTEC)</title>
     <style type="text/css">
...
$rpt_d_inv=$detalle_inspeccion_visual->get_formulario_por_id_sm_y_id_inspeccion($id_servicio,1);
          while ($fila=mysqli_fetch_object($rpt_d_inv)) {
            ...
            <td  align=center><img width="15px" ';
            if($fila->estado==1){
             $html.=' src="imagen/radio.png" ' ;
            }else{
              $html.=' src="imagen/radio_vacio.png" ' ;
            }
            $html.='></td>
              <td  align=center><img width="15px"';
...
$html.='<tr  style=background-color:#E7F3EB>
        <td colspan="7" style="color: green" align=center >PLATO DE COLOCACION</td> ';
...
$html.='<tr  style=background-color:#E7F3EB>
        <td colspan="7" style="color: green" align=center >JERINGAS / TUBERIAS</td> ';
...
$html.='<tr  style=background-color:#E7F3EB>
        <td colspan="7" style="color: green" align=center >KIT INYECCION</td> ';
$rpt_d_inv=$detalle_inspeccion_visual->get_formulario_por_id_sm_y_id_inspeccion($id_servicio,1);
          while ($fila=mysqli_fetch_object($rpt_d_inv)) {
            if($fila->id==71)
            {
...
$html.='<tr  style=background-color:#E7F3EB>
        <td colspan="7" style="color: green" align=center >NEUMATICA</td> ';
$rpt_d_inv=$detalle_inspeccion_visual->get_formulario_por_id_sm_y_id_inspeccion($id_servicio,1);
          while ($fila=mysqli_fetch_object($rpt_d_inv)) {
            if($fila->id==75)
            {
